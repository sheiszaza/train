  ...
  return (
    <div className="card-cont">
      ...
      <div className="lower-side">
        <div>
          <h1 className="font-bold text-slate-600 card-tit">{details.Name}</h1>
          <p className="font-light text-xs">{details.Date}</p>
        </div>
        <div>
          {details.saleday && (
            <div className="card-sale">
              <p className="text-xs text-white">
                Sales end in {details.saleday} days
              </p>
            </div>
          )}
          ...
          <div className="card-prices">
            {details.saleday ? (
              <>
                <h1 className="font-bold text-slate-600 mb-2">
                  ${details.saleprice}
                </h1>
                <h1 className="font-light text-slate-600 line-through mb-2 text-xs">
                  ${details.Price}
                </h1>
                <p className="font-semibold text-white bg-red-600 rounded-xl mb-2 text-xs">
                  -{details.saleperc}%
                </p>
              </>
            ) : (
          ...
          <h1 className="font-light text-sm">
            <span className="text-red-700 font-bold">|</span> Nintendo Switch
          </h1>
